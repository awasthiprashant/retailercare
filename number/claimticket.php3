...
$dbconn = $conn ;
$lsqlstr = "SELECT p.*,t.agentcode,t.dateofsale,t.drawdate,govtname, lotname,drawtime,
...
$govtname = array_key_exists($rowsale->govtname, $GovtArray)?$GovtArray[$rowsale->govtname]:0  ;
